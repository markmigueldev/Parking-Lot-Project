...
public class OfficerLogInGUI extends JFrame {
	...
	public OfficerLogInGUI() {
		...
		contentPane.setLayout(new MigLayout("", "[155px,grow][10px][329px]", "[50px][40px][40px][40px][40px][][][][][][][grow][]"));
		
		JLabel lblNewLabel = new JLabel("PARKING OFFICER");
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(username.isEmpty() || password.isEmpty()) {
					...
					boolean valid = log.verifyOfficer(username, password);
					if(!valid) {
